...
static void tty_upd_scrollup(tty_t *tty) {
  ...
  memmove(tty->dirty, tty->dirty + tty->columns,
          move_sz * sizeof(tty->dirty[0]));
...
static void tty_render(tty_t *tty) {
  ...
  tty->fbdev->ops->write(tty->fbdev, SPRITE_BRK, tty->sp_buf,
                         nsp * sizeof(*sp));
  // clear dirty marks
...
// static char welcome_text[] = " 1111112 11111112112      111112 1111112 \n"
...
static char welcome_text1[] =
    ...
    "   /\\ \\L\\ \\/\\ \\L\\.\\_/\\ \\L\\ \\/\\  __/\\ \\ \\_\\ \\/\\ \\L\\ "
    "\\ \n"
    "   \\ `\\____\\ \\__/.\\_\\ \\____ \\ \\____\\\\ \\_____\\ `\\____\\\n"
    "    \\/_____/\\/__/\\/_/\\/___L\\ \\/____/ \\/_____/\\/_____/\n"
    "                       /\\____/                       \n"
    "                       \\_/__/                        \n"
    "                                2022/04/15 BUPT OSLAB\n"
    "---------------------------------------------------------------------\n";
static void welcome(device_t *dev) {
  ...
  //   }
  // }
  dev->ops->write(dev, 0, welcome_text1, sizeof(welcome_text1) - 1);
}
